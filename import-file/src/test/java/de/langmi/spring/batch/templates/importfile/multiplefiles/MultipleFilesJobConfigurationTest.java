 ...
 */
package de.langmi.spring.batch.templates.importfile.multiplefiles;
...
@ContextConfiguration(locations = {
    "classpath*:spring/batch/job/multiplefiles/multiple-files-job.xml",
    "classpath*:spring/batch/setup/**/*.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class MultipleFilesJobConfigurationTest {
    ...
    private static final String CREATE_TABLE_SQL = "CREATE TABLE BUSINESS_OBJECTS (ID INTEGER GENERATED BY DEFAULT AS IDENTITY, ATTRIBUTE VARCHAR (100))";
